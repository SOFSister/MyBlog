...
1. 添加数据库配置
   ...
   ![image-20220301150103263](./SSMUsage.assets/image-20220301150103263.png)
...
2. 配置扫描mapper路径
   ...
   ![image-20220301153106352](./SSMUsage.assets/image-20220301153106352.png)
...
3. mapper包添加接口类，resources下的mapper文件夹内新建xml配置文件
   ...
   ![image-20220301154107775](./SSMUsage.assets/image-20220301154107775.png)
...
4. service包内添加接口类，service包内添加impl包，impl包内继承实现接口类
   ...
   ![image-20220301154259008](./SSMUsage.assets/image-20220301154259008.png)
...
5. controller包内添加controller类
   ...
   ![image-20220301170210311](./SSMUsage.assets/image-20220301170210311.png)
...
6. 连通测试（测试controller的接口是否正确）
   ...
   ![image-20220301170542597](./SSMUsage.assets/image-20220301170542597.png)
...
2. settings配置
   ...
   ![image-20220302171243975](././SSMUsage.assets/image-20220302171243975.png)

   ![image-20220302171333006](././SSMUsage.assets/image-20220302171333006.png)
...
![image-20220308120534686](././SSMUsage.assets/image-20220308120534686.png)
...
3. 添加配置类
   ...
   ![image-20220309104420463](././SSMUsage.assets/image-20220309104420463.png)
...
2. 添加线程组![image-20220309113418580](././SSMUsage.assets/image-20220309113418580.png)

3. 添加http请求

   ![image-20220309113508761](././SSMUsage.assets/image-20220309113508761.png)

4. 添加结果树

   ![image-20220309113601943](././SSMUsage.assets/image-20220309113601943.png)

5. 添加聚合报告

   ![image-20220309113630168](././SSMUsage.assets/image-20220309113630168.png)

6. 线程组内进行设置

   ![image-20220309113720753](././SSMUsage.assets/image-20220309113720753.png)

7. http内进行设置

   ![image-20220309113822619](././SSMUsage.assets/image-20220309113822619.png)

8. 保存并启动查看聚合报告

   ![image-20220309113930010](././SSMUsage.assets/image-20220309113930010.png)
